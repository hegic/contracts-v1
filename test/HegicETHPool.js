...
contract('HegicETHPool', ([user1, user2, user3]) => {
  ...
  it('Should distribute the profits correctly', async () => {
    ...
    const expected1 = value.mul(startShare1).div(startShare1.add(startShare2)).add(startShare1)
    const expected2 = value.mul(startShare2).div(startShare1.add(startShare2)).add(startShare2)
